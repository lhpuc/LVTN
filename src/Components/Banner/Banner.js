...
const Banner = () => {
  ...
  useEffect(() => {
    setSelectedDistrict("");
    if (selectedCity !== "") {
      const cityDataSearch = filterData.find(
        (value) => value.name === selectedCity
      );
    ...
    <>
      <section className="hero">
        <div className="container">
          <RubberBand>
            <p className="titleName"> Cho sự lựa chọn của bạn</p>
            ...
            <div className="box">
              <Select
                ...
                filterOption={(input, option) =>
                  option.value.includes(input.toString().toLowerCase())
                }
              >
                {cityFilter &&
