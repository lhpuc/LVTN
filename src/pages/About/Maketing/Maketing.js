          ...
          <div className="MarketingWrap">
            ...
            <Zoom>
              <div className="MarketingContent">
                ...
                <h5>PSM</h5>
                <p>
                  Marketing bất động sản là thuật ngữ chuyên dùng để chỉ những
                  người làm marketing trong lĩnh vực kinh doanh bất động sản,
                  mua bán và cho thuê nhà đất.Người làm marketing ngành bất động
                  sản phải có những hiểu biết tổng thể về nền kinh tế; sự phát
                  triển của cơ sở hạ tầng; đặc điểm của vị trí, xu hướng của xã
